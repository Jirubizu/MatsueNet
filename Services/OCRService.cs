    ...
    public class OCRService
    {
        ...
        public async Task<string> Ocr(string imageUrl)
        {
            var res = await http.GetJsonAsync<OCRSpaceJson>(
                $"https://api.ocr.space/parse/imageurl?apikey={config.Config.OCR}&url={imageUrl}");
        ...
        {
            var res = await http.GetJsonAsync<OCRSpaceJson>(
                $"https://api.ocr.space/parse/imageurl?apikey={config.Config.OCR}&url={imageUrl}&language={language.TrimEnd()}");
